...
| Bulk endpoint (ปัจจุบัน) | รวมหลายไซต์ในคำขอเดียว | ที่ cadence default (300 วิ) ใช้ไปแล้ว **~101,000/เดือน** — ชนเพดานพอดี แทบไม่เหลือที่ |
